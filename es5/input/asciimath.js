  ...
  var t = {
          ...
          p = function (t) {
            function e(i) {
              var n = this,
                ...
                s = a[1],
                o = a[2];
              return (n = t.call(this, o) || this).findAsciiMath =
      ...
      406: function (t, e, i) {
        MathJax = Object.assign(i.g.MathJax || {}, i(24).N),
          MathJax.config && MathJax.config.asciimath &&
        ...
        e.N = l,
          function (t) {
            ...
            (e.Object = n({
              ...
              Init: function (args) {
                var obj = this;
                if (args.length === 1 && args[0] === i) return obj;
                if (!(obj instanceof args.call)) obj = new args.call(i);
            ...
            var n = function (t) {
              ...
              r = function (t, e) {
                ...
                if (t instanceof Array) {
                  if (
                    "string" == typeof t[0] && t[1] instanceof Object &&
              ...
              h = function () {
                ...
                if (n(e) && !e.called) c(e, t);
                  ...
                  for (var i = 0, a = t.length; i < a; i++) {t[i].pending--,
              ...
              f = e.Object.Subclass({
                ...
                Push: function () {
                  for (
                    ...
                    (t = r(arguments[e])) !== arguments[e] || t.called ||
                    (t = r(["wait", this, t])), this.queue.push(t);
                  }
              ...
              g = f.Subclass({
                ...
                signals: {},
                find: function (t) {
                  return g.signals[t] || (g.signals[t] = new g(t)),
                    g.signals[t];
                },
              });
          ...
          function (t) {
            var e = u.MathJax;
            e || (e = u.MathJax = {});
            var i = "Apple Computer, Inc." === h.vendor &&
                void 0 === h.vendorSub,
              n = 0,
              a = [],
              s = function () {
                for (var t = 0, i = a.length; t < i; t++) {e.Ajax.head
                    .removeChild(a[t]);}
                a = [];
              },
              r = { MathJax: "" };
            e.Ajax = {
              ...
              Load: function (t, i) {
                ...
                if (t = this.fileURL(t), this.loading[t]) this.addHook(t, i);
                  ...
                  if (
                    this.head = (this.head, null), !this.loader[n]
                  ) {
              ...
              timer: {
                ...
                checkSafari2: function (t, e, i) {
                  t.time(i) ||
                    (p.styleSheets.length > e && p.styleSheets[e].cssRules &&
            ...
            Element: function (t, e, i) {
              ...
              if (e) {
                if (e.hasOwnProperty("style")) {
                  var s = e.style;
                  for (n in e.style = {}, s) {s.hasOwnProperty(n) &&
                      (e.style[n.replace(/-([a-z])/g, this.ucMatch)] = s[n]);}
                }
                for (
                  n in l.Hub.Insert(a, e), e
                ) {
          ...
          l.Localization = {
            ...
            loadFile: function (t, e, i) {
              (i = l.Callback(i),
                ...
                t.match(/^([a-z]+:|\[MathJax\])/)) ||
                (t = (this.strings[this.locale].directory ||
                  this.directory + "/" + this.locale ||
                  "[MathJax]/localization/" + this.locale) + "/" + t);
            ...
            loadDomain: function (t, e) {
              ...
              if (n) {
                if (
                  !n.isLoaded && (i = this.loadFile(this.locale, n))
                ) {
          ...
          l.Message = {
            ...
            filterText: function (t, e, i) {
              return "simple" === l.Hub.config.messageStyle && ("LoadFile" === i
                ? (this.loading ||
          ...
          l.Hub = {
            ...
            Insert: function (t, e) {
              for (var i in e) {
                e.hasOwnProperty(i) &&
                  ("object" != typeof e[i] || e[i] instanceof Array ||
          ...
          i.ElementJax = o.Subclass({
            ...
            Attach: function (t, e) {
              ...
              return t.MathJax.state === this.STATE.UPDATE
                ? n.Clone(this)
            ...
            Clone: function (t) {
              var e;
              for (e in this) {
                this.hasOwnProperty(e) && void 0 === t[e] && "newID" !== e &&
                  delete this[e];
              }
              for (e in t) {
                t.hasOwnProperty(e) &&
      ...
      477: function () {
        ...
        t = MathJax.ElementJax.mml,
            ...
            nodeMake: function (t, e) {
              for (
                var i = t.MML["TeXmathchoice" === e ? "mathchoice" : e](),
                  n = this.data[0] && this.data[0].inferred && this.inferRow
                    ? this.data[0].data
                    : this.data,
                  a = 0,
                  s = n.length;
          ...
          t.munderover.Augment({
            toMmlNode: function (t) {
              var e = null == this.data[this.under]
                ? "mover"
          ...
          MathJax.ElementJax.mml.Augment({
            Init: function () {
              if (
                ...
                this.root.display || "display" !== this.root.attr.mode ||
          ...
          function (t) {
            (t.mbase = MathJax.Object.Subclass(
              ...
              (t.mrow = t.mbase.Subclass({
                ...
                isEmbellished: function () {
                  for (
                    var t = !1, e = 0, i = this.data.length;
                    e < i;
                    e++
                  ) {
                    if (null != this.data[e]) {
                ...
                NonSpaceLength: function () {
                  for (
                    var t = 0, e = 0, i = this.data.length;
                    e < i;
                    e++
                  ) {
                  ...
                  if (
                    ...
                    for (var i = 1, n = this.data.length; i < n; i++) {
                      this.data[i] &&
                        (this.SetData(
                          "sep" + i,
                          t.mo(e.separators.charAt(i - 1)).With({
                            separator: !0,
                          }),
                        ),
      ...
      247: function () {
        ...
        !function (t) {
          var e,
            i = MathJax.Object.Subclass({
              ...
              removeChild: function (t) {
                ...
                if (e !== i) {
                  return this.childNodes.splice(e, 1),
            ...
            n = {
              ...
              createElementNS: function (i, n) {
                var a = e[n]();
                return "mo" === n && t.config.useMathMLspacing &&
                  (a.useMMLspacing = 128),
                  a;
              },
          ...
          function d(t, e) {
            var i;
            return i = u ? n.createElement("m:" + t) : n.createElementNS(p, t),
              e && i.appendChild(e),
              i;
          }
          var m = [
          ...
          function L(t) {
            ...
            t.hasChildNodes() &&
              (!t.firstChild.hasChildNodes() ||
                ...
                "(" != (e = t.firstChild.firstChild.nodeValue) && "[" != e &&
                  "{" != e ||
                t.removeChild(t.firstChild),
                !t.lastChild.hasChildNodes() ||
                "mrow" != t.nodeName && "M:MROW" != t.nodeName ||
                ")" != (e = t.lastChild.firstChild.nodeValue) && "]" != e &&
                  "}" != e ||
          ...
          function M(t) {
            ...
            switch (
              ...
              case 1:
                ...
                if (
                  "boolean" == typeof e.func && e.func
                ) {
                  return "^" == (r = t.charAt(0)) || "_" == r || "/" == r ||
                      "|" == r || "," == r ||
                      1 == e.input.length && e.input.match(/\w/) && "(" != r
                    ? [d(e.tag, n.createTextNode(e.output)), t]
                    : ((i = d("mrow", d(e.tag, n.createTextNode(e.output))))
                      .appendChild(a[0]),
                      [i, a[1]]);
                }
                if (L(a[0]), "sqrt" == e.input) return [d(e.tag, a[0]), a[1]];
                if (
                  void 0 !== e.rewriteleftright
                ) {
                  return (i = d(
                    "mrow",
                ...
                if ("cancel" == e.input) {
                  return (i = d(e.tag, a[0]))
                    .setAttribute("notation", "updiagonalstrike"),
                    [i, a[1]];
                }
                ...
                return (i = d(e.tag, a[0])).setAttribute(e.atname, e.atval),
                  [i, a[1]];
              case 2:
                if (null == (a = M(t = v(t, e.input.length)))[0]) {
                  return [
                    d("mo", n.createTextNode(e.input)),
                    t,
                  ];
                }
                L(a[0]);
          ...
          function k(t) {
            ...
            if (
              ...
              void 0 !== i.func && i.func && 3 != (a = O(t)).ttype &&
                5 != a.ttype && (i.input.length > 1 || 4 == a.ttype) &&
          ...
          function D(t, e) {
            ...
            do {
              ...
              (5 != i.ttype && (9 != i.ttype || e) || 0 == C) && null != i &&
              "" != i.output
            );
            if (5 == i.ttype || 9 == i.ttype) {
              var l = o.childNodes.length;
              if (
                l > 0 && "mrow" == o.childNodes[l - 1].nodeName &&
                      ...
                      removeChild: function (t) {
                        ...
                        if (e !== i) {
                          return this.childNodes.splice(e, 1),
                            ...
                            t === this.lastChild && (this.childNodes.length
                              ? this.lastChild =
                                this.childNodes[this.childNodes.length - 1]
                              : this.lastChild = null),
                            e &&
          ...
          (t = MathJax.InputJax.AsciiMath).Augment({
            ...
            formatError: function (t, i, n) {
              ...
              return MathJax.Hub.signal.Post([
